...
class FS_cla(object):
    ...
    def loadDataset(self,filename, data, target):  # 加载数据集  split以某个值为界限分类train和test
        with open(filename, 'r') as csvfile:
            ...
            dat = np.array(dat)
            data, target = np.split(dat, (1170, ), axis=1)
            data[data == ''] = 0.0
    ...
    def Run(self):
        ...
        data = []
        target = []
        data, target = self.loadDataset(r'GSE72056_melanoma_single_cell_revised_v2_gene_filtering_ben3388mal1257_deg1170.csv', data, target)   #数据划分
...
if __name__ == '__main__':
    ...
    #file_name_data1 = 'Ave_Accuracy_RFE_f1-14_svm_100_times.csv'
    #file_name_data2 = 'Var_Accuracy_RFE_f1-14_svm_100_times.csv'
    #file_name_data3 = 'Std_Accuracy_RFE_f1-14_svm_100_times.csv'
    file_name_data1 = 'Ave_Ari_RFE_f1-14_GMM_100_times.csv'
    file_name_data2 = 'Var_Ari_RFE_f1-14_GMM_100_times.csv'
    file_name_data3 = 'Std_Ari_RFE_f1-14_GMM_100_times.csv'
