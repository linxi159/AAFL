...
class GMM(object):
    ...
    def Run(self):
        ...
        testSet = []
        split = 0.7
        self.loadDataset(r'GSE72056_melanoma_single_cell_revised_v2_gene_filtering_ben3388mal1257_deg_ben_mal_top11.csv', split, trainingSet, testSet)   #数据划分
        print('Train set: ' + str(len(trainingSet)))
        print('Test set: ' + str(len(testSet)))

        x_train, y_train = np.split(trainingSet, (22, ), axis=1)
        x_test, y_test = np.split(testSet, (22, ), axis=1)
...
if __name__ == '__main__':
    ...
    file_name_data1 = './ARI_top14-1_gaussian_mixture_models/ARI_top11_100_times_gaussian_mixture_models.csv'
    ...
    print('Ave_ari_top11_100_times_gaussian_mixture_models: ' + repr(ari_data1))
